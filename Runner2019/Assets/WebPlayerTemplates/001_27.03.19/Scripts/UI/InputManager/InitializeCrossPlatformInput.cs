...
[InitializeOnLoad]
public class InitializeCrossPlatformInput 
{
    ...
    static InitializeCrossPlatformInput()
    {
    ...
    private static void SetEnabled(string defineName, bool enable, bool onlyForMobile)
    {
        foreach (BuildTargetGroup group in onlyForMobile ? mobileBuildTargetGroups : buildTargetGroups)
        {
